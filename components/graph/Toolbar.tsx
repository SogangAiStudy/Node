...
export function Toolbar({
  ...
  return (
    <div className="absolute left-4 right-4 top-4 z-10 flex flex-col gap-3 rounded-xl bg-white/80 backdrop-blur-md p-3 shadow-lg border border-slate-200">
      {/* Top Row: Actions & Global Filters */}
      ...
      {/* Bottom Row: Team Tags */}
      <div className="flex items-center gap-3 pl-1 overflow-x-auto no-scrollbar py-0.5">
        <div className="flex items-center gap-2 text-[11px] font-bold text-slate-400 uppercase tracking-wider shrink-0 mr-1">
